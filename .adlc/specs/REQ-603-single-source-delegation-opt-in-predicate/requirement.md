...
- **The config parser, and shell-state-free binary resolution.** Both are REQ-609. This REQ names their present fail-opens as a known limitation in BR-14 rather than claiming them fixed.
