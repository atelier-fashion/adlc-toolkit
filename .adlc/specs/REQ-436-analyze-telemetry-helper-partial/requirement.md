...
- [ ] AC-12: `/init`'s partials handling provably covers `partials/emit-step-telemetry.sh` and its `.md` (demonstrated by reading the copy step and confirming the glob/explicit list includes the new files, or by a dry-run).
